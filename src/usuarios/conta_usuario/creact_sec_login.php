...
if(count($_POST) > 0) {
    ...
    if($num_userexistente < 1 ){
        if($num_useremail < 1 ){
            $sql_code = "INSERT INTO usuarios (nome, master_account, id_masteraccount, permissao_usuario, nascimento, cpf_cnpj, telefone_celular, email, senha, data) 
            VALUE('$nomeUser', '$masterAcont', '$idUser', '$permissao_usuario', '$nascimentoUser', '$docUser', '$telUser', '$emailUser', '$passwordUser', NOW())";
...
$sql_userSecundario = "SELECT * FROM usuarios WHERE id_masteraccount  = $idUser";
$query_userSecundario = $mysqli->query($sql_userSecundario) or die($mysqli->error);
$num_userSecundario = $query_userSecundario->num_rows;
...
<html lang="pt-br">
  <head>
    ...
    <title>Aprovacredi - Cadastro Corretor</title>
    ...
    <link rel="stylesheet" href="../../../css/creact_sec_login.css">
...
<body>
                ...
                <div class="d-flex flex-column flex-shrink-0" style="height: 100vh; background-color: #fff; box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 3px, rgba(0, 0, 0, 0.24) 0px 1px 2px;">
                    ...
                    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                        ...
                        <div class="dropend">  
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="../add_user/solic_cadastro.php" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;" width="25" height="25" fill="currentColor" class="bi bi-grid-1x2-fill" viewBox="0 0 16 16">
                                ...
                                <li>
                                    <a href="../add_user/user_registered.php" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;" width="25" height="25" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                                ...
                                <li>
                                    <a href="../add_user/user_bloqueado.php" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;" width="25" height="25" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                    ...
                    <div class="dropdown border-top">
                        ...
                        <ul class="dropdown-menu text-small shadow">
                            <li><a class="dropdown-item" href="editar_user_acont.php">Perfil</a></li>
                            <li><a class="active dropdown-item" href="creact_sec_login.php">Cadastro Corretor</a></li>
        ...
        <div class="offcanvas offcanvas-start"  id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="width: 280px;">
                    <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-light" style="width: 279px; height: 100%;">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu text-small shadow">
                                <li><a class="active dropdown-item" href="editar_user_acont.php">Perfil</a></li>
                                <li><a class="dropdown-item" href="creact_sec_login.php">Cadastro Corretor</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="../../../logout.php">Sair</a></li>
                            </ul>
                        </div>
    ...
    <section class="workspace">
        <div class="container container-workspace">
            <!--Conteudo da Pagina-->
            <h2 style="text-align:center; margin-top:15px; margin-bottom:10px;"><b>Cadastro de Corretores</b></h2>
            <div class="area-btn">
                <button type="buttonadd" class="buttonadd" data-bs-toggle="modal" data-bs-target="#addcorretor">
                    <span class="buttonadd__text">Add Corretor</span>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="center" scope="col-4"><span class="statusUser">Status</span></th>
                            <th scope="col-3"></th>
                        </tr>
                    </thead>
                    <?php if($num_userSecundario == 0) { ?>
                                        <tr>
                                            <td colspan="6">Nem um corretor cadastrado</td>
                                        </tr>
                                    <?php } else { 
                                        while($usuarioSecundario = $query_userSecundario->fetch_assoc()){
                                        ?>
                    <tbody>
                        <tr>
                            <th scope="row">
                                <div class="containerimg">
                                    <img class="img-perfil" 
                                        <?php if($usuarioSecundario['nome_arq_ftn_Perfil'] == null) { ?> 
                                            src="../../../css/img/fotoperfil.jpg"  
                                        <?php } else { echo 'src="../'.$usuarioSecundario["path_ftn_perfil"].'"';}?>
                                    alt="">
                                </div>
                            </th>
                            <th class="emailarea">
                                <span><?php echo $usuarioSecundario['nome']; ?></span><br/>
                                <span class="font-email"><b>E-mail:</b> <?php echo $usuarioSecundario['email']; ?></span>
                            </th>
                            <th>
                                <?php if($usuarioSecundario['permissao_usuario'] == 1) {  ?>
                                    <div class="statusUser statusAccont">
                                        <div class="colorstatus "></div> 
                                        <span id="colorstatustitle">Ativo</span>
                                    </div>
                                <?php } else { ?>
                                    <div class="statusAccont statusUser">
                                        <div class="colorstatusred"></div> 
                                        <span id="colorstatustitlered">Inativo</span>
                                    </div>
                                <?php } ?>
                            </th>
                            <th>
                                <div class="grupbtn">
                                    <div class="btnleftauto">
                                        <!--Botão Deletar-->
                                        
                                            <button type="submit" class="button" data-bs-toggle="modal" data-bs-target="#exclusaoContaLabel">
                                            ...
                                            <!-- Modal Exclusão de Contas Secundaria -->
                                            <div class="modal fade" id="exclusaoContaLabel" tabindex="-1" aria-labelledby="exclusaoContaLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body text-center text-uppercase text-danger">
                                                        <b class=" text-danger">ATENÇÃO:</b> Você está prestes a excluir a conta de <?php echo $usuarioSecundario['nome'] ?> permanentemente. Esta ação é irreversível. Tem certeza de que deseja continuar?
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                                                        <a href="delet_sec_login.php?id=<?php echo $usuarioSecundario['id']; ?>"><button type="button" class="btn btn-danger">Excluir</button></a>
                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                        <!--botão Editar-->
                                        <button class="buttonEditar" data-bs-toggle="modal" data-bs-target="#editarAcontSec<?php echo $usuarioSecundario['id'];  ?>">
                    ...
                    <div class="modal fade" id="editarAcontSec<?php echo $usuarioSecundario['id'];  ?>" tabindex="-1" aria-labelledby="editarAcontSecLabel<?php echo $usuarioSecundario['id'];  ?>" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="editarAcontSecLabel<?php echo $usuarioSecundario['id'];  ?>">Editar perfil de <?php echo $usuarioSecundario['nome']; ?></h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="container-admuser">
                                    <?php if($usuarioSecundario['permissao_usuario'] == 1) {  ?>

                                        <form  method="POST" action="inativaAtiva_login.php?id=<?php echo $usuarioSecundario['id'];?>">
                                            <button class="BtnBanir" type="submit">
                                                <div class="sign"><i class="fi fi-ss-user-xmark"></i></div>
                                                <div class="text">Inativar</div>
                                            </button>
                                        </form>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <form method="POST" action="inativaAtiva_login.php?id=<?php echo $usuarioSecundario['id'];?>">
                                            <button class="BtnReativar">
                                                <div class="signReativar"><i class="fi fi-ss-user-add"></i></div>
                                                <div class="textReativar">Reativar</div>
                                            </button>
                                        </form>
                                    <?php }?>
                                </div>
                                <div style="flex-direction: column;" class="container"> 
                                    <?php
                                        ...
                                        $fileresult = "ftnPerfil".$usuarioSecundario['id'];
                                    
                                        if(isset($_FILES[$fileresult])) {
                                            $idusuariosecundario = $usuarioSecundario['id'];
                                            $nomearquivoNovoFtnPerfil = "user_".$usuarioSecundario['id']."_".uniqid();
                                        ...
                                        if(isset($_FILES[$fileresult])) {
                                            ...
                                            if($deu_certorgcnh) { $mysqli->query("UPDATE usuarios 
                                                ...
                                                WHERE id = '$idusuariosecundario'")  or die($mysqli->error);
                                            if($deu_certorgcnh) echo "<script>window.location.href = 'creact_sec_login.php'</script>"; else echo "<script>alert('ERRO: falha inesperada ao enviar arquivo.'); history.go(-1);</script>";
                                        }}
                                    ?>


                                    <form enctype="multipart/form-data" method="POST">
                                        <div class="imgPerfilGrup">
                                            <div class="imgarea">
                                                <img class="img-perfil-lg" 
                                                    <?php if($usuarioSecundario['nome_arq_ftn_Perfil'] == null) { ?> 
                                                        src="../../../css/img/fotoperfil.jpg"  
                                                    <?php } else { echo 'src="../'.$usuarioSecundario["path_ftn_perfil"].'"';}?>
                                                alt="">
                                            </div>
                                            <div class="inputperfilgrup">
                                            <div class="input-group">
                                                <input name="ftnPerfil<?php echo $usuarioSecundario['id']; ?>" type="file" class="form-control" id="inputFtnPerfil<?php echo $usuarioSecundario['id']?>" aria-describedby="inputFtnPerfilUpload<?php echo $usuarioSecundario['id']; ?>" aria-label="Upload">
                                                <button class="btn btn-outline-secondary" type="submit" id="inputFtnPerfilUpload<?php echo $usuarioSecundario['id']; ?>">Enviar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <form onsubmit="return validarForm2()" method="POST" action="editar_sec_login.php?id=<?php echo $usuarioSecundario['id'];?>" class="row g-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="inputregister" for="inputfullname2<?php echo $usuarioSecundario['path_ftn_perfil']?>" class="form-label">Nome Completo <?php echo $fileresult ?></label>
                                        <input required value="<?php echo $usuarioSecundario['nome'];?>" name="fullname" type="text" class="form-control" id="inputfullname2<?php echo $usuarioSecundario['id']?>" placeholder="Digite seu nome...">
                                        <p id="mensagemErro2" class="mensagemErro" style="color: red;"></p>
                                    </div>
                            
                                    <div class="col-md-6">
                                        <label class="inputregister" for="inputdate2<?php echo $usuarioSecundario['id']?>" class="form-label">Data de Nascimento</label>
                                        <input required value="<?php echo $usuarioSecundario['nascimento'];?>" name="nascdate"  type="date" class="form-control" id="inputdate2<?php echo $usuarioSecundario['id']?>">
                                    </div>
                                </div>
                                <div class="row">    
                                    <div class="col-md-6">
                                        <label class="inputregister" for="inputdoc2<?php echo $usuarioSecundario['path_ftn_perfil']?>" class="form-label <?php if($errodoc === true){ echo "colordanger"; }; ?>">CPF/CNPJ</label>
                                        <input disabled value="<?php echo $usuarioSecundario['cpf_cnpj'];?>" name="docuser"   type="text" class="cpfOuCnpj form-control <?php if($errodoc === true){ echo "borderdanger"; }; ?>" id="inputdoc2<?php echo $usuarioSecundario['id']?>" placeholder="Digite seu documento...">
                                        <p id="mensagemErroDoc2" class="mensagemErro" style="color: red;"></p>
                                        <?php 
                                        if($errodoc === true){
                                            echo '<p id="mensagemErroDoc" class="mensagemErro" style="color: red;"><i class="fi fi-ss-exclamation"></i> CPF já Cadastrado</p>';
                                        };
                                        ?>
                                    </div>
                                        
                                    <div class="col-md-6">
                                        <label class="inputregister" for="inputnumberphone2<?php echo $usuarioSecundario['path_ftn_perfil']?>" class="form-label">telefone</label>
                                        <input required  value="<?php echo $usuarioSecundario['telefone_celular'];?>" name="contactuser"  type="text" class="telefone form-control" id="inputnumberphone2<?php echo $usuarioSecundario['id']?>" placeholder="(11) 1234-56789">
                                        <p id="mensagemErroTel2" class="mensagemErro" style="color: red;"></p>
                                    </div> 
                                </div>
                                <div class="row">     
                                    <div class="col-md-12">
                                        <label class="inputregister" for="inputemail2<?php echo $usuarioSecundario['path_ftn_perfil']?>" class="form-label <?php if($erroemail === true){ echo "colordanger"; }; ?>">E-mail:</label>
                                        <input required value="<?php echo $usuarioSecundario['email'];?>" name="emailuser" type="email" class="form-control <?php if($erroemail === true){ echo "borderdanger"; }; ?>" id="inputemail2<?php echo $usuarioSecundario['id']?>" placeholder="Digite seu e-mail...">
                                        <p id="mensagemErroEmail2" class="mensagemErro" style="color: red;"></p>
                                        <?php 
                                        if($erroemail === true){
                                ...
                                <div style="margin-top:5px;display:flex;" class="btnsalvardados">
    ...
    <!-- Modal Criação de Conta secundaria -->
    <div class="modal fade" id="addcorretor" tabindex="-1" aria-labelledby="addcorretorLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" style="text-aling:center;" id="addcorretorLabel">Adicionar Corretor</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form onsubmit="return handleFormSubmit()" method="POST" class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6" style="display: flex; flex-direction: column;">
                        ...
                        <img onclick="mostrarSenha2()" src="../../../css/img/olho.png" id="imgsenhacadastro" alt="" class="imgocultarsenha">
                        <p id="mensagemErroPassword" class="mensagemErroPassword" style="margin-top:8px;color: red;"></p>
                    </div>
                    ...
                    <div class="col-md-6" style="display: flex; flex-direction: column;">
                        ...
                        <img onclick="mostrarSenha2()" src="../../../css/img/olho.png" id="inputconfirmsenha" alt="" class="imgocultarsenha">
                        <p id="mensagemErroPasswordConfirm" class="mensagemErroPassword" style="margin-top:8px;color: red;"></p>
                    </div>   
                    <div style="display:none;" class="inputaceite form-check">
                        <input class="form-check-input" type="checkbox" id="termosdeuso" checked >
                    ...
                    <button onclick="mostrarLoader()" type="submit" id="btnCriarLoginSec">
                        <div id="btnCriarLoginSecText">
                            <span>Criar Conta</span>
                            <svg class="svgbtn" width="34" height="34" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="37" cy="37" r="35.5" stroke="white" stroke-width="3"></circle>
                                <path d="M25 35.5C24.1716 35.5 23.5 36.1716 23.5 37C23.5 37.8284 24.1716 38.5 25 38.5V35.5ZM49.0607 38.0607C49.6464 37.4749 49.6464 36.5251 49.0607 35.9393L39.5147 26.3934C38.9289 25.8076 37.9792 25.8076 37.3934 26.3934C36.8076 26.9792 36.8076 27.9289 37.3934 28.5147L45.8787 37L37.3934 45.4853C36.8076 46.0711 36.8076 47.0208 37.3934 47.6066C37.9792 48.1924 38.9289 48.1924 39.5147 47.6066L49.0607 38.0607ZM25 38.5L48 38.5V35.5L25 35.5V38.5Z" fill="white"></path>
                            </svg>
                        </div>
                        
                        <div style="display:none;" id="btnCriarLoginSecLoader" class="load">
