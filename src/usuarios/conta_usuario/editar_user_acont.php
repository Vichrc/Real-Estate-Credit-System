...
$usuarioPrimario = $query_userPrimario->fetch_assoc();
    ...
    if(!isset($_GET['id'])){
        ...
        if($usuarioPrimario['permissao_usuario'] === "3" || $usuarioPrimario['permissao_usuario'] === "2" ){
...
$sql_userPerfil = "SELECT * FROM usuarios WHERE id  = $idperfil";
$query_userPerfil = $mysqli->query($sql_userPerfil) or die($mysqli->error);
$num_userPerfil = $query_userPerfil->num_rows;
$userPerfill = $query_userPerfil->fetch_assoc();
...
if(count($_POST) > 0) {
    ...
    $cepuser =  $mysqli->escape_string($_POST['cepuser']);
    $ruauser =  $mysqli->escape_string($_POST['ruauser']);
    $numerouser =  $mysqli->escape_string($_POST['numerouser']);
    $bairrouser =  $mysqli->escape_string($_POST['bairrouser']);
    $cidadeuser =  $mysqli->escape_string($_POST['cidadeuser']);
    $estadouser =  $mysqli->escape_string($_POST['estadouser']);
    ...
    $sql_code_user = "SELECT * FROM usuarios WHERE id = '$idUser'";
    ...
    $UsuarioSecundario = $sql_query_user->fetch_assoc();
        ...
        if($num_useremail < 1){
            $sql_code = "UPDATE usuarios SET nome = '$nomeUser', 
            nascimento = '$nascimentoUser', 
            telefone_celular = '$telUser', 
            email = '$emailUser', 
            ogradouro = '$ruauser',  
            numero = '$numerouser',  
            bairro = '$bairrouser',  
            ...
            if($deu_certo) {
                ...
                <script>
                    ...
                    window.location.href='editar_user_acont.php';
                </script>";
                exit();  
            }
        } else {
...
<head>
    ...
    <link rel="icon" href="../../../css/img/favicon.png" type="image/png">
    <link rel="stylesheet" href="../../../css/edit_perf_princ.css">
    ...
    <section class="workspace">
        <div class="container container-workspace">
            ...
            <div class="containerperfil">
                <div class="imgperfil desktopform"> 
                    <form id="form" action="upload_ftn_perfil.php" enctype="multipart/form-data" method="POST">
                      
                        <div class="imgPerfilGrup">
                            
                                <label class="picture" for="picture__input" tabIndex="0">
                                    <div class="imgarea">
                                        <img class="img-perfil-lg imgUpload" 
                                            <?php if($userPerfill['nome_arq_ftn_Perfil'] == null) { ?> 
                                                src="../../../css/img/fotoperfil.jpg"  
                                            <?php } else { echo 'src="../'.$userPerfill["path_ftn_perfil"].'"';}?>
                                        alt="">
                                    </div>
                                </label>
                                <input onchange='submitform()' type="file" name="picture__input" id="picture__input">
                    ...
                    <div class="menuPerfil">
                        <a class="active" href="editar_user_acont.php">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" style="margin-right:10px;" width="25" height="25" fill="currentColor"><circle cx="12" cy="7" r="4"/>
                                <path d="M5,16v4H19V16a3,3,0,0,0-3-3H8A3,3,0,0,0,5,16Z"/><path d="M21,24H16V22h5a1,1,0,0,0,1-1V16h2v5A3,3,0,0,1,21,24Z"/><path d="M2,8H0V3A3,3,0,0,1,3,0H8V2H3A1,1,0,0,0,2,3Z"/><path d="M8,24H3a3,3,0,0,1-3-3V16H2v5a1,1,0,0,0,1,1H8Z"/><path d="M24,8H22V3a1,1,0,0,0-1-1H16V0h5a3,3,0,0,1,3,3Z"/>
                            </svg>
                            Principal
                        </a>
                        <?php if ($usuarioPrimario['id'] === $userPerfill['id'] ) {?>
                        <a href="alt_senha_user.php">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" viewBox="0 0 512 512" xml:space="preserve" style="margin-right:10px; margin-bottom:7px;" width="25" height="25" fill="currentColor">
                            ...
                            <span style="margin-top:3px;">Senha</span>  
                        </a>
                        <?php }?>
                    </div>
                </div>
                ...
                <div class="inputareaperfil">
                <h2 style="text-align:center; margin-top:15px; margin-bottom:10px;"><b>Alterar Perfil</b></h2>
                ...
                <form onsubmit="return handleFormSubmit()" method="POST" class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input value="<?php echo $userPerfill['nome'];?>" name="fullname" type="text" class="form-control" id="inputfullname" placeholder="Digite seu nome...">
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="<?php echo $userPerfill['nascimento'];?>" name="nascdate"  type="date" class="form-control" id="inputdate">
                    </div>

                    <div class="col-md-6">
                        <label class="inputregister" for="inputdoc" class="form-label <?php if($errodoc === true){ echo "colordanger"; }; ?>">CPF/CNPJ</label>
                        <input value="<?php echo $userPerfill['cpf_cnpj'];?>" name="docuser"   type="text" class="cpfOuCnpj form-control <?php if($errodoc === true){ echo "borderdanger"; }; ?>" id="inputdoc" placeholder="Digite seu documento...">
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="<?php echo $userPerfill['telefone_celular'];?>" name="contactuser"  type="text" class="telefone form-control" id="inputnumberphone" placeholder="(11) 1234-56789">
                    ...
                    <div class="col-md-12">
                        ...
                        <input value="<?php echo $userPerfill['email'];?>" name="emailuser" type="email" class="form-control <?php if($erroemail === true){ echo "borderdanger"; }; ?>" id="inputemail" placeholder="Digite seu e-mail...">
                    ...
                    <div class="col-md-4">
                        <label class="inputregister" for="inputnumberphone" class="form-label">CEP</label>
                        <input required value="<?php echo $userPerfill['cep'];?>" name="cepuser"  type="text" class="form-control" id="cepInput" placeholder="0000-000">
                        <p id="mensagemErroTel" class="mensagemErro" style="color: red;"></p>
                    </div> 
                    <div class="col-md-4">
                        <label class="inputregister" for="inputnumberphone" class="form-label">Rua</label>
                        <input value="<?php echo $userPerfill['logradouro'];?>" name="ruauser"  type="text" class="form-control"  placeholder="Digite o nome da rua...">
                        <p id="mensagemErroTel" class="mensagemErro" style="color: red;"></p>
                    </div>   
                    <div class="col-md-4">
                        <label class="inputregister" for="inputnumberphone" class="form-label">Número</label>
                        <input value="<?php echo $userPerfill['numero'];?>" name="numerouser"  type="text" class="form-control"  placeholder="Digite o número da sua casa...">
                        <p id="mensagemErroTel" class="mensagemErro" style="color: red;"></p>
                    </div>   
                    <div class="col-md-4">
                        <label class="inputregister" for="inputnumberphone" class="form-label">Bairro</label>
                        <input value="<?php echo $userPerfill['bairro'];?>" name="bairrouser"  type="text" class="form-control"  placeholder="Digite seu bairro" >
                        <p id="mensagemErroTel" class="mensagemErro" style="color: red;"></p>
                    </div> 

                    <div class="col-md-4">
                        <label class="inputregister" for="inputnumberphone" class="form-label">Cidade</label>
                        <input readonly required value="<?php echo $userPerfill['cidade'];?>" name="cidadeuser"  type="text" class="form-control"  placeholder="Digite seu...">
                        <p id="mensagemErroTel" class="mensagemErro" style="color: red;"></p>
                    </div> 

                    <div class="col-md-4">
                        <label class="inputregister" for="inputnumberphone" class="form-label">Estado</label>
                        <input readonly required value="<?php echo $userPerfill['estado'];?>" name="estadouser"  type="text" class="form-control"  placeholder="Selecione sua cidade">
                        <p id="mensagemErroTel" class="mensagemErro" style="color: red;"></p>
                    </div> 
                    <div class="btnAltPerfil">
