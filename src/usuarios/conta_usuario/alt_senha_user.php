...
if(count($_POST) > 0) {
    ...
    $confPassword = $mysqli->escape_string($_POST['confPassword']);
            ...
            if(!password_verify($oldPassword, $usuarioPrimario['senha'])) {
                $erro01Password = true;
            } else {
                ...
                if($deu_certo) {
                    ...
                    echo "
                    <script>
                        alert('Alterado com sucesso, você sera desconectado agora');
            ...
            <div class="containerperfil">
                <div class="imgperfil desktopform"> 
                    ...
                    <div class="menuPerfil">
                        ...
                        <a class="active"  href="alt_senha_user.php">
                ...
                <h2 style="text-align:center; margin-top:15px; margin-bottom:10px;"><b>Alterar Senha</b></h2>
                <?php if($usuarioPrimario['permissao_usuario'] == 2 || $usuarioPrimario['permissao_usuario'] == 3 ) {?>
                    <div style="margin-top:5px;display:flex;" class="btnsalvardados">
                        <button style="margin-left:auto;" class="btnresetsenha">
                ...
                <div class="mobileform"> 
                 ...
                 <div class="formresetsenha">
                    <p style="color:red;text-align:center;"><b>ATENÇÂO:</b> A Aprovacredi não se responsabiliza pela troca de senha; portanto, a senha de acesso ao sistema é de responsabilidade exclusiva do usuário.</p>

                    <form onsubmit="return validarIgualdadePassword()" action="" method="post">
                        <div class="col" style="display: flex; flex-direction: column;">
                            <label class="inputregister" for="inputnumberphone" class="form-label <?php if($erro01Password == true) { ?> colordanger <?php }; ?>">Senha Atual:</label>
                            <input  name="oldpassword" id="senhaantiga" type="password" class="form-control<?php if($erro01Password == true) { ?> borderdanger <?php }; ?>"  placeholder="Digite sua senha atual: " >
                            <img onclick="mostrarSenha3()" src="../../../css/img/olho.png" id="imgsenhaantiga" alt="" class="imgocultarsenha">
                            <p id="mensagemErroTel"  style="color: red;margin-top:8px;"><?php if($erro01Password == true) { ?><i class="fi fi-ss-exclamation"></i> Senha incorreta<?php } ?></p>
                        </div> 

                        <div class="col" style="display: flex; flex-direction: column;">
                            <label  class="inputregister" for="inputsenha" class="form-label">Crie uma senha</label>
                            <input value="<?php if(isset($_POST['passwordacont'])) echo $_POST['passwordacont'];?>" name="newPassword" type="password" class="form-control" id="inputsenha" placeholder="Digite sua senha...">
                            <img onclick="mostrarSenha3()" src="../../../css/img/olho.png" id="imgsenhacadastro" alt="" class="imgocultarsenha">
                            <p id="mensagemErroPassword" class="mensagemErroPassword" style="color: red;margin-top:8px;"></p>
                        </div>
                            
                        <div class="col" style="display: flex; flex-direction: column;">
                            <label class="inputregister" for="inputrepetirsenha" class="form-label">Repita a nova senha</label>
                            <input type="password" name="confPassword" class="form-control" id="inputrepetirsenha" placeholder="Repita sua senha...">
                            <img onclick="mostrarSenha3()" src="../../../css/img/olho.png" id="inputconfirmsenha" alt="" class="imgocultarsenha">
                            <p id="mensagemErroPasswordConfirm" class="mensagemErroPassword" style="color: red;margin-top:8px;"></p>
                        </div>  

                                <div style="margin-top:5px;display:flex;" class="btnsalvardados">
                                    <button style="margin-left:auto;" type="submit" class="cta">
                                        <span class="hover-underline-animation"> Mudar senha </span>
                                            <svg
                                                id="arrow-horizontal"
