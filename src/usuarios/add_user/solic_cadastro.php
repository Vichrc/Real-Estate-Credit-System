...
$sql_userCadastrado = "SELECT * FROM usuarios Where permissao_usuario = '0'";
...
<html lang="pt-br">
  <head>
    ...
    <title>Aprovacredi - Solicitação de Cadastro</title>
...
<body>
    ...
    <section class="workspace">
        <div class="container container-workspace">
            <!--Conteudo da Pagina-->
            <h2 style="text-align:center; margin-top:15px; margin-bottom:10px;"><b>Solicitação de Cadastro</b></h2>
            <div class="container-table">
                <table class="table">
                    ...
                    <?php if($num_userCadastrado == 0) { ?>
                                        <tr>
                                            <td colspan="6">Nem um Corretor/Correspondente aguardando aprovação</td>
                                        </tr>
                                    <?php } else { 
                            ...
                            <th>
                                <div class="grupbtn dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="../conta_usuario/inativaAtiva_login.php?id=<?php echo $usersCadastrados['id'];?>"><?php if($usersCadastrados['permissao_usuario'] != 0) {echo "Bloquear usuário";} else { echo "Aprovar Cadastro";} ?></a></li>
                                    </ul>
                                </div>
                            </th>
                        </tr>
