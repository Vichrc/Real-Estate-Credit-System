...
$sql_userCadastrado = "SELECT * FROM usuarios Where permissao_usuario not in ('3', '0', '5')";
                    ...
                    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                        ...
                        <div class="dropend">  
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="user_registered.php" class="active dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;" width="25" height="25" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                                ...
                                <li>
                                    <a href="user_bloqueado.php" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;" width="25" height="25" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                            ...
                            <div class="dropend">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="solic_cadastro.php" class="active dropdown-item">
                                                <svg xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;" width="25" height="25" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                                                    <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.708l.547.548 1.17-1.951a.5.5 0 1 1 .858.514ZM11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
                                                    <path d="M2 13c0 1 1 1 1 1h5.256A4.493 4.493 0 0 1 8 12.5a4.49 4.49 0 0 1 1.544-3.393C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4Z"/>                                </svg>
                                                </svg>      
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr tyle="display:flex;">
                            ...
                            <th>
                                <span class="dadosUser"; style="<?php if($usersCadastrados['permissao_usuario'] != 0) {echo "color:green;";} else { echo "color:red;";} ?>"><?php echo removerTextoDepoisDoEspaco($usersCadastrados['nome']); ?></span>
                                <span class="doc_user"  style="<?php if($usersCadastrados['permissao_usuario'] != 0) {echo "color:green;";} else { echo "color:red;";} ?>"><?php echo $usersCadastrados['cpf_cnpj']; ?></span>
                            </th>
                        
                            <th>
                                <span class="statusUser dadosUser"  style="<?php if($usersCadastrados['permissao_usuario'] != 0) {echo "color:green;";} else { echo "color:red;";} ?>"><?php echo $usersCadastrados['cpf_cnpj']; ?></span>
                            </th>
                       
                            <th>
                                <span class=" dadosUser dadosUserTel"  style="<?php if($usersCadastrados['permissao_usuario'] != 0) {echo "color:green;";} else { echo "color:red;";} ?>"><?php echo $usersCadastrados['telefone_celular']; ?></span>
                            </th>
                            <th>
                                <div class="grupbtn dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="../conta_usuario/inativaAtiva_login.php?id=<?php echo $usersCadastrados['id'];?>"><?php if($usersCadastrados['permissao_usuario'] != 0) {echo "Bloquear usuário";} else { echo "Reativar usuário";} ?></a></li>
                                    </ul>
                                </div>
                            </th>
                        </tr>
                            ...
                            <div class="modal-body">
                                <div class="DocUser">
                                    ...
                                    <?php if(isset($usersCadastrados['path_doc_cpfcnpj'])) { ?>
                                        <a href="<?php echo '../../../' . $usersCadastrados['path_doc_cpfcnpj']; ?>"  target="_blank">Click Aqui</a>
                                    <?php } else {?>
                                ...
                                <div class="DocUser">
                                    ...
                                    <?php if(isset($usersCadastrados['path_doc_residencia'])) { ?>
                                        <a href="<?php  echo '../../../' . $usersCadastrados['path_doc_residencia']; ?>"  target="_blank">Click Aqui</a>
                                    <?php } else {?>
                                        <p>Documento ainda não enviado!</p>
                                    <?php }?>
                                </div>
