...
$pasta = "/important/docComprador/";
$pasta2 = "../../../important/docComprador/";
...
$sql_dadosComprador = "SELECT * FROM db_comprador WHERE id_comprador = $id_comprador";
$query_dadosComprador = $mysqli->query($sql_dadosComprador) or die($mysqli->error);
$num_dadosComprador = $query_dadosComprador->num_rows;
$dadosComprador = $query_dadosComprador->fetch_assoc();
$id_proposta = $dadosComprador['id_proposta'];


$sql_docComprador = "SELECT * FROM db_doc_comp WHERE id_comprador = $id_comprador";
$query_docComprador = $mysqli->query($sql_docComprador) or die($mysqli->error);
$num_docComprador = $query_docComprador->num_rows;
$docComprador = $query_docComprador->fetch_assoc();


    if($usuarioPrimario['permissao_usuario'] != 3){

        if($usuarioPrimario['permissao_usuario'] != 2){
            if($usuarioPrimario['id'] != $dadosComprador['id_corretor']) {
                header("Location: ../../../logout.php");
                exit();
            }
        }
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES)) {
        ...
        if(isset($_FILES['cpf_file'])) {
            $idusuario = $id_comprador;
            $nomeArquivoNovo = "comp_".$id_comprador."_".uniqid();
            ...
            if($extensao_Arqv_cpf != ''){
                ...
                if ($num_dadosDocComprador > 0) {
                    if($deu_certor) { $mysqli->query(
                        "UPDATE db_doc_comp 
                        SET path_cpf = '$path' 
                        WHERE id_comprador = '$id_comprador'")  or die($mysqli->error);
                    if($deu_certor) echo "<script>window.location.href = 'editarComprador.php?id=$id_comprador'</script>"; else echo "<script>alert('ERRO: falha inesperada ao enviar arquivo.'); history.go(-1);</script>";
                    }
                } else {
                    $sql_code = "INSERT INTO db_doc_comp (id_corretor, id_proposta, id_comprador, path_cpf) 
                    VALUE ('$idUser' ,'$id_proposta' ,'$id_comprador' , '$path')";
        ...
        if(isset($_FILES['rg_cnh_file'])) {
            ...
            if($extensao_Arqv_rg_cnh != ''){
                ...
                if ($num_dadosDocComprador > 0) {
                    ...
                    $sql_code = "INSERT INTO db_doc_comp (id_corretor, id_proposta, id_comprador, path_rg_cnh) 
                    VALUE ('$idUser' ,'$id_proposta' ,'$id_comprador' , '$path')";
                    $deu_certo = $mysqli->query($sql_code) or die($mysqli->error);
                }
            }
        ...
        if(isset($_FILES['comp_resi_file'])) {
            ...
            if($extensao_Arqv_Compr_resi != ''){
                ...
                if ($num_dadosDocComprador > 0) {
                    ...
                    $sql_code = "INSERT INTO db_doc_comp (id_corretor, id_proposta, id_comprador, path_comp_resi) 
                    VALUE ('$idUser' ,'$id_proposta' ,'$id_comprador' , '$path')";
                    $deu_certo = $mysqli->query($sql_code) or die($mysqli->error);
                }
            }
        ...
        if(isset($_FILES['comp_renda_file'])) {
            ...
            if($extensao_Arqv_Compr_renda != ''){
                ...
                if ($num_dadosDocComprador > 0) {
                    ...
                    $sql_code = "INSERT INTO db_doc_comp (id_corretor, id_proposta, id_comprador, path_comp_ren) 
                    VALUE ('$idUser' ,'$id_proposta' ,'$id_comprador' , '$path')";
                    $deu_certo = $mysqli->query($sql_code) or die($mysqli->error);
                }
            }
        ...
        if(isset($_FILES['comp_estado_civil_file'])) {
            ...
            if($extensao_Arqv_Compr_estado_civil != ''){
                ...
                if ($num_dadosDocComprador > 0) {
                    ...
                    $sql_code = "INSERT INTO db_doc_comp (id_corretor, id_proposta, id_comprador, path_Comp_estado) 
                    VALUE ('$idUser' ,'$id_proposta' ,'$id_comprador' , '$path')";
                    $deu_certo = $mysqli->query($sql_code) or die($mysqli->error);
                }
            }
        ...
        if(isset($_FILES['impost_Renda_File'])) {
            ...
            if($extensao_Arqv_imp_renda != ''){
                ...
                if ($num_dadosDocComprador > 0) {
                    ...
                    $sql_code = "INSERT INTO db_doc_comp (id_corretor, id_proposta, id_comprador, path_imp_renda) 
                    VALUE ('$idUser' ,'$id_proposta' ,'$id_comprador' , '$path')";
                    $deu_certo = $mysqli->query($sql_code) or die($mysqli->error);
                }
            }
        ...
        if(isset($_FILES['rg_chh_conj_file'])) {
            ...
            if($extensao_Arqv_rgcnh_conj != ''){        
                ...
                if ($num_dadosDocComprador > 0) {
                    ...
                    $sql_code = "INSERT INTO db_doc_comp (id_corretor, id_proposta, id_comprador, path_conjugue_rg_cnh) 
                    VALUE ('$idUser' ,'$id_proposta' ,'$id_comprador' , '$path')";
                    $deu_certo = $mysqli->query($sql_code) or die($mysqli->error);
                }
            }
        ...
        if(isset($_FILES['cpf_Cônjuge_file'])) {
            ...
            if($extensao_Arqv_cpf_conj != ''){ 
                ...
                if ($num_dadosDocComprador > 0) {
                    ...
                    $sql_code = "INSERT INTO db_doc_comp (id_corretor, id_proposta, id_comprador, path_cpf_conjugue) 
                    VALUE ('$idUser' ,'$id_proposta' ,'$id_comprador' , '$path')";
                    $deu_certo = $mysqli->query($sql_code) or die($mysqli->error);
                }
            }
        ...
        if(isset($_FILES['comp_ren_conj'])) {
            ...
            if($extensao_Arqv_comp_renda_conj != ''){ 
                ...
                if ($num_dadosDocComprador > 0) {
                    ...
                    $sql_code = "INSERT INTO db_doc_comp (id_corretor, id_proposta, id_comprador, path_comp_ren_conjug) 
                    VALUE ('$idUser' ,'$id_proposta' ,'$id_comprador' , '$path')";
                    $deu_certo = $mysqli->query($sql_code) or die($mysqli->error);
                }
            }
        ...
        if(isset($_FILES['impos_renda_conj'])) {
            $idusuario = $id_comprador;
            $nomeArquivoNovo = "comprador_".$id_comprador."_".uniqid();
            ...
            if($extensao_Arqv_imposto_renda_conj != ''){ 
                ...
                if ($num_dadosDocComprador > 0) {
                    ...
                    if($deu_certor) {
                        $mysqli->query(
                            "INSERT INTO db_doc_comp (id_corretor, id_proposta, id_comprador, path_imp_renda_conjug) 
                            VALUE ('$idUser' ,'$id_proposta' ,'$id_comprador' , '$path')") or die($mysqli->error);
                        if($deu_certor) echo "<script>window.location.href = 'editarComprador.php?id=$id_comprador'</script>"; else echo "<script>alert('ERRO: falha inesperada ao enviar arquivo.'); history.go(-1);</script>";
                    }
                }
            }
...
<body>
    ...
    <section class="workspace">
        <div class="container container-workspace containerdados">
            ...
            <div class="areaInicial">
                <div class="retorno">
                    <a href="gestaopropst.php?id=<?php echo $dadosComprador['id_proposta'] ?>"><i class="fi fi-sr-undo"></i> Voltar</a>
                </div>
                <div class="btnArea">
            ...
            <form action="editarDadosCOmprador.php?id=<?php echo $id_comprador ?>" method="post">
                ...
                <div class="infoArea row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <input required value="<?php echo $dadosComprador['nome_comprador']; ?>" name="nameComprador" type="text" id="nameComprador" class="form-control">
                    </div>

                    <div class="col-md-3 col-sm-12">
                        <label for="nascimentoComprador" class="form-label">Nascimento</label>
                        <input required value="<?php echo $dadosComprador['data_nascimento_comprador']; ?>" name="nascimentoComprador" type="date" id="nascimentoComprador" class="form-control">
                    </div>
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <select onchange="mostrarEsconderConjugue(this)" name="estadoCivil" class="form-select" aria-label="Default select example">
                            <option select value="<?php echo $dadosComprador['estado_civil__comprador']; ?>"><?php echo $dadosComprador['estado_civil__comprador']; ?></option>
                ...
                <div class="infoArea row">
                    <div class="col-md-8 col-sm-12">
                        ...
                        <input value="<?php echo $dadosComprador['email_comprador']; ?>" required name="emailComprador" type="email" id="emailComprador" class="form-control">
                    </div>

                    <div class="col-md-4 col-sm-12">
                        <label for="telefoneComprador" class="form-label">Telefone</label>
                        <input value="<?php echo $dadosComprador['telefone_comprador']; ?>" required name="telefoneComprador" type="text" id="telefoneComprador" class="form-control telefone">
                    </div>
                </div>
                <div class="infoArea row">
                    <div class="col-md-3 col-sm-12">
                        <label for="rgComprador" class="form-label">RG</label>
                        <input value="<?php echo $dadosComprador['rg_comprador']; ?>" required name="rgComprador" type="text" id="rgComprador" class="form-control">
                    </div>

                    <div class="col-md-3 col-sm-12">
                        <label for="emissorComprador" class="form-label">Orgão Emissor</label>
                        <input value="<?php echo $dadosComprador['org_emissor']; ?>" required name="emissorComprador" type="text" id="emissorComprador" class="form-control">
                    </div>

                    <div class="col-md-3 col-sm-12">
                        <label for="dataEmissaoComprador" class="form-label">Data Emissor</label>
                        <input value="<?php echo $dadosComprador['data_emissao']; ?>" required name="dataEmissaoComprador" type="date" id="dataEmissaoComprador" class="form-control">
                    </div>

                    <div class="col-md-3 col-sm-12">
                        <label for="cpfComprador" class="form-label">CPF</label>
                        <input value="<?php echo $dadosComprador['cpf_comprador']; ?>" required name="cpfComprador" type="text" id="cpfComprador" class="form-control cpfMask">
                    </div>
                </div>
                <div class="infoArea row">
                    <div class="col-md-6 col-sm-12">
                        <label for="nomeMaeComprador" class="form-label">Nome da Mãe</label>
                        <input value="<?php echo $dadosComprador['nome_mae_comprador']; ?>" required name="nomeMaeComprador" type="tect" id="nomeMaeComprador" class="form-control">
                    </div>

                    <div class="col-md-6 col-sm-12">
                        <label for="nomepaiComprador" class="form-label">Nome do Pai</label>
                        <input value="<?php echo $dadosComprador['nome_pai_comprador']; ?>" name="nomepaiComprador" type="text" id="nomepaiComprador" class="form-control">
                    </div>
                </div>


                <!--Cônjuge-->
                <div <?php if($dadosComprador['estado_civil__comprador'] == 'casado')  {} else { ?> class="conjugueDados" <?php } ?>id="conjugueDados">
                    <div class="headerSubDados">
                    ...
                    <div class="infoArea row">
                        <div class="col-md-8 col-sm-12">
                            ...
                            <input value="<?php echo $dadosComprador['nome_conjuge']; ?>" name="nameConjugue" type="text" id="nameConjugue" class="form-control">
                        </div>

                        <div class="col-md-4 col-sm-12">
                            <label for="nascimentoConjugue" class="form-label">Nascimento</label>
                            <input value="<?php echo $dadosComprador['nascimento_conjuge']; ?>" name="nascimentoConjugue" type="date" id="nascimentoConjugue" class="form-control">
                        </div>
                    ...
                    <div class="infoArea row">
                        <div class="col-md-8 col-sm-12">
                            ...
                            <input value="<?php echo $dadosComprador['email_conjuge']; ?>" name="emailConjugue" type="email" id="emailConjugue" class="form-control">
                        </div>

                        <div class="col-md-4 col-sm-12">
                            <label for="telefoneConjugue" class="form-label">Telefone</label>
                            <input value="<?php echo $dadosComprador['telefone_conjuge']; ?>" name="telefoneConjugue" type="text" id="telefoneConjugue" class="form-control telefone">
                        </div>
                    </div>
                    <div class="infoArea row">
                        <div class="col-md-3 col-sm-12">
                            <label for="rgConjugue" class="form-label">RG</label>
                            <input value="<?php echo $dadosComprador['rg_conjuge']; ?>" name="rgConjugue" type="text" id="rgConjugue" class="form-control">
                        </div>

                        <div class="col-md-3 col-sm-12">
                            <label for="emissorConjugue" class="form-label">Orgão Emissor</label>
                            <input value="<?php echo $dadosComprador['emissor_rg_conjuge']; ?>" name="emissorConjugue" type="text" id="emissorConjugue" class="form-control">
                        </div>

                        <div class="col-md-3 col-sm-12">
                            <label for="dataEmissaoConjugue" class="form-label">Data Emissor</label>
                            <input value="<?php echo $dadosComprador['data_emissao_conjuge']; ?>" name="dataEmissaoConjugue" type="date" id="dataEmissaoConjugue" class="form-control">
                        </div>

                        <div class="col-md-3 col-sm-12">
                            <label for="cpfConjugue" class="form-label">CPF</label>
                            <input value="<?php echo $dadosComprador['cpf_conjuge']; ?>" name="cpfConjugue" type="text" id="cpfConjugue" class="form-control cpfMask">
                        </div>
                    </div>
                    <div class="infoArea row">
                        <div class="col-md-6 col-sm-12">
                            <label for="nomeMaeConjugue" class="form-label">Nome da Mãe</label>
                            <input value="<?php echo $dadosComprador['nome_mae_conjugue']; ?>" name="nomeMaeConjugue" type="tect" id="nomeMaeConjugue" class="form-control">
                        </div>

                        <div class="col-md-6 col-sm-12">
                            <label for="nomepaiConjugue" class="form-label">Nome do Pai</label>
                            <input value="<?php echo $dadosComprador['nome_pai_conjugue']; ?>" name="nomepaiConjugue" type="text" id="nomepaiConjugue" class="form-control">
                        </div>
                    </div>
                    <div class="infoArea form-check form-switch">
                        <input <?php if($dadosComprador['conju_compoe_renda'] == "sim") {?> checked <?php } ?> value="Sim" onchange="mostrarEsconderRendaConjugue()" class="form-check-input" type="checkbox" role="switch" id="compoerenda" name="compoerenda">
                        <label class="form-check-label" for="compoerenda">Compoe renda?</label>
                    </div>

                    <div  <?php if($dadosComprador['conju_compoe_renda'] == "sim") { } else { ?> class="compRendaConjugue" <?php } ?>  id="compRendaConjugue">
                        <div class="headerSubDados">
                        ...
                        <div class="infoArea row">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <input value="<?php echo $dadosComprador['profissao_conjugue']; ?>" name="profissaoConj" type="tect" id="profissaoConj" class="form-control">
                            </div>

                            <div class="col-md-4 col-sm-12">
                                <label for="admissaoConj" class="form-label">Data de Admissão</label>
                                <input value="<?php echo $dadosComprador['data_admissao_conjugue']; ?>" name="admissaoConj" type="text" id="admissaoConj" class="form-control">
                            </div>

                            <div class="col-md-4 col-sm-12">
                                <label for="pisConj" class="form-label">Pis</label>
                                <input value="<?php echo $dadosComprador['pis_conjugue']; ?>" name="pisConj" type="tect" id="pisConj" class="form-control pisInput">
                            </div>

                            <div class="col-md-6 col-sm-12">
                                <label for="empregadorConj" class="form-label">Empregador</label>
                                <input value="<?php echo $dadosComprador['empregador_conjugue']; ?>" name="empregadorConj" type="text" id="empregadorConj" class="form-control">
                            </div>


                            <div class="col-md-6 col-sm-12">
                                <label for="cnpjEmpregConj" class="form-label">CNPJ do Empregador</label>
                                <input value="<?php echo $dadosComprador['cnpj_empregador_conjugue']; ?>" name="cnpjEmpregConj" type="tect" id="cnpjEmpregConj" class="form-control cnpjMAsk">
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <select  name="tipoRendaConjComprador" class="form-select" id="tipoRendaConjComprador" aria-label="Default select example">
                                    <option value="<?php echo $dadosComprador['tipoderenda_conjugue']; ?>"><?php echo $dadosComprador['tipoderenda_conjugue']; ?></option>
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <input value="<?php echo $dadosComprador['renda_bruta_conjugue']; ?>" name="rendaBrutaConjComprador" type="text" id="rendaBrutaConjComprador" class="form-control formatReal">
                            </div>

                            <div class="col-md-4 col-sm-12">
                                <label for="rendaLiquidaConjComprador" class="form-label">Renda Líquida</label>
                                <input value="<?php echo $dadosComprador['renda_liquida_conjugue']; ?>"  name="rendaLiquidaConjComprador" type="text" id="rendaLiquidaConjComprador" class="form-control formatReal">
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <select name="bancoConju" class="form-select" id="bancoConju" aria-label="Default select example">
                                    <option value="<?php echo $dadosComprador['banco_conjugue']; ?>"><?php echo $dadosComprador['banco_conjugue']; ?></option>
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <input value="<?php echo $dadosComprador['agencia_conjugue']; ?>" name="agenciaConj" type="text" id="agenciaConj" class="form-control">
                            </div>

                            <div class="col-md-4 col-sm-12">
                                <label for="contaConj" class="form-label">Conta</label>
                                <input value="<?php echo $dadosComprador['conta_conjugue']; ?>" name="contaConj" type="tect" id="contaConj" class="form-control">
                            </div>
                ...
                <div class="infoArea row">
                    <div disabled class="col-md-4 col-sm-12">
                        ...
                        <input value="<?php echo $dadosComprador['cep_comprador']; ?>" required name="cepuser2" type="tect" id="cepInput2" class="form-control cepInput">
                    </div>

                    <div disabled class="col-md-4 col-sm-12">
                        <label for="cidadeuser2" class="form-label">Cidade</label>
                        <input value="<?php echo $dadosComprador['cidade_casa_comprador']; ?>" required name="cidadeuser2" type="text" id="cidadeuser2" class="form-control">
                    </div>

                    <div class="col-md-4 col-sm-12">
                        <label for="estadouser2" class="form-label">Estado</label>
                        <input value="<?php echo $dadosComprador['estado_casa_comprador']; ?>" required name="estadouser2" type="text" id="estadouser2" class="form-control">
                    </div>
                </div>
                <div class="infoArea row">
                    <div class="col-md-3 col-sm-12">
                        <label for="ruauser2" class="form-label">Rua</label>
                        <input value="<?php echo $dadosComprador['endereco_comprador']; ?>" required name="ruauser2" type="tect" id="ruauser2" class="form-control">
                    </div>

                    <div class="col-md-3 col-sm-12">
                        <label for="completComprador" class="form-label">Complemento</label>
                        <input value="<?php echo $dadosComprador['complemento_casa_comprador']; ?>" name="completComprador" type="text" id="completComprador" class="form-control">
                    </div>

                    <div class="col-md-3 col-sm-12">
                        <label for="numerocasaComprador" class="form-label">Número</label>
                        <input value="<?php echo $dadosComprador['numero_casa_comprador']; ?>" required name="numerocasaComprador" type="text" id="numerocasaComprador" class="form-control">
                    </div>

                    <div class="col-md-3 col-sm-12">
                        <label for="bairroComprador" class="form-label">Bairro</label>
                        <input value="<?php echo $dadosComprador['bairro_casa_comprador']; ?>" required name="bairrouser2" type="text" id="bairroComprador" class="form-control">
                    </div>
                </div>
                <div class="headerSubDados">
                ...
                <div class="infoArea row">
                    <div class="col-md-4 col-sm-12">
                        ...
                        <input value="<?php echo $dadosComprador['profissao_comprador']; ?>" required name="profissaoComprador" type="tect" id="profissaoComprador" class="form-control">
                    </div>

                    <div class="col-md-4 col-sm-12">
                        <label for="pisComprador" class="form-label">PIS</label>
                        <input value="<?php echo $dadosComprador['pis']; ?>" required name="pisComprador" type="text" id="pisComprador" class="form-control pisInput">
                    </div>

                    <div class="col-md-4 col-sm-12">
                        <label for="dataAdmissãoComprador" class="form-label">Data Admissão</label>
                        <input value="<?php echo $dadosComprador['data_admissao']; ?>" required name="dataAdmissãoComprador" type="date" id="dataAdmissãoComprador" class="form-control">
                    </div>

                    <div class="col-md-8 col-sm-12">
                        <label for="empregadorComprador" class="form-label">Empregador</label>
                        <input value="<?php echo $dadosComprador['empregador']; ?>" required name="empregadorComprador" type="text" id="empregadorComprador" class="form-control">
                    </div>

                    <div class="col-md-4 col-sm-12">
                        <label for="cnpjEmpregadorComprador" class="form-label">CNPJ</label>
                        <input value="<?php echo $dadosComprador['cnpj_empregador']; ?>" required name="cnpjEmpregadorComprador" type="text" id="cnpjEmpregadorComprador" class="form-control cnpjMAsk">
                    </div>
                </div>
                <div class="infoArea row">
                    <div class="col-md-4 col-sm-12">
                        ...
                        <select required name="tipoRendaComprador" class="form-select" id="tipoRendaComprador" aria-label="Default select example">
                            <option value="<?php echo $dadosComprador['tipo_renda']; ?>"><?php echo $dadosComprador['tipo_renda']; ?></option>
                            <option value="formal">Formal</option>
                            <option value="informal">Informal</option>
                        </select>  
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <input value="<?php echo $dadosComprador['renda_bruta_comprador']; ?>" required name="rendaBrutaComprador" type="text" id="rendaBrutaComprador" class="form-control formatReal">
                    </div>

                    <div class="col-md-4 col-sm-12">
                        <label for="rendaLiquidaComprador" class="form-label">Renda Líquida</label>
                        <input value="<?php echo $dadosComprador['renda_liquida_comprador']; ?>" required name="rendaLiquidaComprador" type="text" id="rendaLiquidaComprador" class="form-control formatReal">
                    </div>
                </div>
                ...
                <div class="infoArea row">
                    <div class="col-md-4 col-sm-12">
                        ...
                        <select required name="bancoComprador" class="form-select" id="bancoComprador" aria-label="Default select example">
                            <option value="<?php echo $dadosComprador['banco_comprador']; ?>"><?php echo $dadosComprador['banco_comprador']; ?></option>
                            <option value="itau">Itau</option>
                            <option value="bradesco">Bradesco</option>
                            <option value="santander">Santander</option>
                            <option value="caixa">Caixa</option>
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <input value="<?php echo $dadosComprador['agencia_comprador']; ?>" required name="agenciaComprador" type="text" id="agenciaComprador" class="form-control">
                    </div>

                    <div class="col-md-4 col-sm-12">
                        <label for="contaComprador" class="form-label">Conta Bancaria</label>
                        <input value="<?php echo $dadosComprador['conta_comprador']; ?>" required name="contaComprador" type="text" id="contaComprador" class="form-control">
                    </div>
                </div>
    ...
    <div class="modal fade" id="modalDeletarComprador" tabindex="-1" aria-labelledby="modalDeletarCompradorLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-footer">
                ...
                <a href="deletComprador.php?id=<?php echo $dadosComprador['id_comprador'];?>">
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="documentoCompradorLabel">Documentos de <?php echo removerTextoDepoisDoEspaco($dadosComprador['nome_comprador']); ?></h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
            <form enctype="multipart/form-data" method="POST">
                <div class="modal-body">          
                    <?php if(!isset($docComprador['path_cpf'])) { ?>
                    ...
                    <?php if(!isset($docComprador['path_rg_cnh'])) { ?>
                        <div class="inputforms">
                    ...
                    <?php if(!isset($docComprador['path_comp_resi'])) { ?>
                        <div class="inputforms">
                    ...
                    <?php if(!isset($docComprador['path_comp_ren'])) { ?>
                        <div class="inputforms">
                            <label class="" ><b>Comprovante de Renda</b></label>
                            <div class="input-group">
                                <input name="comp_renda_file" type="file" class="form-control" id="">
                            </div>
                        </div>
                    <?php } else { ?>
                        <div style="margin: 15px 0;text-align:center;">                                    
                            <span style="color:green;"><b>Comprovante de Renda Já enviado!!!</b></span>
                        </div>

                    <?php } ?>

                    <?php if(!isset($docComprador['path_Comp_estado'])) { ?>
                        <div class="inputforms">
                    ...
                    <?php if(!isset($docComprador['path_imp_renda'])) { ?>
                        <div class="inputforms">
                            <label class="" ><b>Imposto de Renda</b></label>
                            <div class="input-group">
                                <input name="impost_Renda_File" type="file" class="form-control" id="">
                            </div>
                        </div>
                    <?php } else { ?>
                        <div style="margin: 15px 0;text-align:center;">                                    
                            <span style="color:green;"><b>Imposto de Renda Já enviado!!!</b></span>
                        </div>

                    <?php } ?>


                    <?php if($dadosComprador['estado_civil__comprador'] == 'casado') { ?>

                        <?php if(!isset($docComprador['path_conjugue_rg_cnh'])) { ?>
                            <div class="inputforms">
                        ...
                        <?php if(!isset($dadosComprador['path_cpf_conjugue'])) { ?>
                            <div class="inputforms">
                        ...
                        <?php if(!isset($docComprador['path_comp_ren_conjug'])) { ?>
                            <div class="inputforms">
                                <label class="" ><b>Comprovante de Renda Cônjuge</b></label>
                                <div class="input-group">
                                    <input name="comp_ren_conj" type="file" class="form-control" id="">
                                </div>
                            </div>
                        <?php } else { ?>
                            <div style="margin: 15px 0;text-align:center;">                                    
                                <span style="color:green;"><b>Comprovante de Renda Cônjuge Já enviado!!!</b></span>
                            </div>

                        <?php } ?>

                        <?php if(!isset($docComprador['path_imp_renda_conjug'])) { ?>
                            <div class="inputforms">
                                <label class="" ><b>Imposto de Renda Cônjuge</b></label>
                                <div class="input-group">
                                    <input name="impos_renda_conj" type="file" class="form-control" id="">
                                </div>
                            </div>
                        <?php } else { ?>
                            <div style="margin: 15px 0;text-align:center;">                                    
                                <span style="color:green;"><b>Imposto de Renda Cônjuge Já enviado!!!</b></span>
                            </div>
