...
$usuarioPrimario = $query_userPrimario->fetch_assoc();
    ...
    if($usuarioPrimario['master_account'] == 1) {

        $sql_MyPropost = "SELECT * FROM db_propostas WHERE id_MasterAcont = $idUser";
        $query_MyPropost = $mysqli->query($sql_MyPropost) or die($mysqli->error);
        $num_MyPropost = $query_MyPropost->num_rows;

    } else {
        $sql_MyPropost = "SELECT * FROM db_propostas WHERE id_usuario  = $idUser";
        $query_MyPropost = $mysqli->query($sql_MyPropost) or die($mysqli->error);
        $num_MyPropost = $query_MyPropost->num_rows;
    }
                    ...
                    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                        ...
                        <div class="dropend">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="../gestao/myPropost.php" class=" active dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;" width="25" height="25" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                            ...
                            <div class="dropend">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="myPropost.php" class="active dropdown-item">
                                                <svg xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;" width="25" height="25" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                                                    <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                                                    <path d="M7 5.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0zM7 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0z"/>
                                                </svg>
        ...
        <div class="container container-workspace">
            ...
            <div class="container-table-proposta">
                <table class="table-proposta table">
                    <thead>
                        <tr>
                            <th style="text-align: center;" class="myPropost-hiden" scope="col-1">Corretor</th>
                            <th scope="col-3">Nome/CPF</th>
                            <th class="myPropost-hiden" scope="col-3">Valor Financiado</th>
                        ...
                        <tr scope="row">
                            <th class="myPropost-hiden" scope="col-1">
                                <div class="containerimg">
                                    ...
                                    <?php if($userSec['nome_arq_ftn_Perfil'] == null) { ?> 
                                            src="../../../css/img/fotoperfil.jpg"  
                                        <?php } else { echo 'src="../../usuarios/'.$userSec["path_ftn_perfil"].'"';}?>  
                                    alt="">
                                    <span><?php echo removerTextoDepoisDoEspaco($myPropost['nome_usuario']); ?></span>
                                </div>
                            </th>
                            <th class="textareaproposta">
                                <div class="nomearea">
                                    <span><?php echo removerTextoDepoisDoEspaco($myPropost['nome_comprador']); ?></span>
                                    <span class=""><b>CPF:</b> <?php echo $myPropost['cpf_comprador']; ?></span>
                                </div>
                            </th>
                            ...
                            <th class="edicaoProposta">
                                <button class="buttonEditar" data-bs-toggle="modal" data-bs-target="#editarAcontSec">
