                ...
                <div class="d-flex flex-column flex-shrink-0" style="height: 100vh; background-color: #fff; box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 3px, rgba(0, 0, 0, 0.24) 0px 1px 2px;">
                    ...
                    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                        ...
                        <div class="dropend">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="novaProposta.php" class="active dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-right:10px;" width="25" height="25" fill="currentColor" class="bi bi-grid-1x2-fill" viewBox="0 0 16 16">
    ...
    <section class="workspace">
        <div class="container container-workspace">
            ...
            <div class="headerArea">
                <h1><b>Criar uma Proposta</b></h1>
                <p>Crie uma proposta para ser processada pela nossa equipe com os bancos parceiros da Aprovacredi de forma agilizada!</p>
            </div>
            <div class="FormCreatProposta">
                <form onsubmit="return handleFormSubmit()" action="criacaoProposta.php" method="POST">
                    <div class="inputArea">
                    ...
                    <div class="inputArea row">
                        <div class="col-md-6 col-sm-12 inputSimul">
                            ...
                            <input name="valorTotalImo" type="text" class="form-control formatReal" id="valorimovel" placeholder="R$ 0,00">
                            ...
                            <p id="mensagemErroValImovel" class="mensagemErro" style="color: red;"></p>
                        </div>
                        <div class="col-md-6 col-sm-12 inputSimul">
                            <label for="valorfinanciado" class="form-label">Valor Financiado</label>
                            <input onblur="validarvalorfinanciado()" name="ValorTotalFinan" type="text" class="form-control formatReal" id="valorfinanciado" placeholder="R$ 0,00">
                    ...
                    <div class="inputArea row">
                        <div class="col-md-6 col-sm-12 inputSimul">
                            ...
                            <select onchange='mudou_a_UF(this)' id="estado" class="estado form-select" aria-label="Default select example" name="estadoImovel">
                        ...
                        <div class="col-md-6 col-sm-12 inputSimul">
                            ...
                            <select id='opt_de_cidades' class="estado form-select" aria-label="Default select example" name="cidadeImovel">
