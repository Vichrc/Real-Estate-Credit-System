                    ...
                    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                        ...
                        <div class="dropend">
                            ...
                            <li class="nav-item"  data-bs-toggle="dropdown" aria-expanded="false">
                                <a href="#" class="active nav-link py-3 border-bottom rounded-0" aria-current="page" data-bs-toggle="tooltip" data-bs-placement="right">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="index.php" class="active dropdown-item">
